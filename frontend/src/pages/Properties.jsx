...
const MOCK = [
  {
    id: 1,
    title: 'Modern Villa with Roof Garden',
    price: 24500000,
    property_type: 'house',
    listing_type: 'buy',
    bedrooms: 4,
  ...
  {
    id: 2,
    title: 'Contemporary House near Patan',
    price: 18500000,
    property_type: 'house',
    listing_type: 'buy',
    bedrooms: 3,
  ...
  {
    id: 3,
    title: 'Apartment in Civil Mall Area',
    price: 8500000,
  ...
  {
    id: 4,
    title: 'Residential Land — River Access',
    price: 3200000,
    property_type: 'land',
    listing_type: 'buy',
    bedrooms: 0,
  ...
  {
    id: 5,
    title: 'Office Space — Durbar Marg',
    price: 12000000,
  ...
  {
    id: 7,
    title: 'Commercial Building — Chitwan',
    price: 52000000,
  ...
  {
    id: 8,
    title: 'Luxury Apartment — Jhamsikhel',
    price: 35000000,
    property_type: 'apartment',
    listing_type: 'buy',
    bedrooms: 4,
...
const Properties = () => {
  ...
  return (
    <div
      ...
      style={{ background: '#FAFAFA', marginTop: '-88px', minHeight: '100vh' }}
    >
      <section className="properties-hero hero-section">
        ...
        <div
          ...
          style={{ position: 'relative', zIndex: 2, paddingTop: '160px', paddingBottom: '40px' }}
        >
          <div className="properties-hero-content" data-animate>
            ...
            >
              Showing {properties.length} exclusive listings across Nepal. Find your dream home,
              land, or commercial space today.
            </p>
            <div className="properties-hero-stats">
              <div className="properties-hero-stat">
                <span>{properties.length}</span> Listings
              </div>
              <div className="properties-hero-stat-divider"></div>
              <div className="properties-hero-stat">
                <span>17</span> Locations
              </div>
              <div className="properties-hero-stat-divider"></div>
              <div className="properties-hero-stat">
                <span>380+</span> Verified Sellers
              </div>
            </div>
          </div>

          <div
            className="premium-search-console-wrapper"
            data-animate
      ...
      <section className="properties-results-section" style={{ padding: '60px 0 100px' }}>
        <div className="container-wide">
          <div
            className="properties-controls-bar"
            data-animate
            style={{
              display: 'flex',
          ...
          {loading ? (
            <div style={{ display: 'flex', justifyContent: 'center', padding: '100px 0' }}>
              <div
                ...
                style={{ width: 40, height: 40, borderTopColor: 'var(--gold)' }}
              />
            </div>
          ) : (
          ...
          {!loading && properties.length === 0 && (
            <div className="empty-state-elegant" style={{ marginTop: '20px' }}>
              ...
              <p style={{ maxWidth: 400, margin: '0 auto 24px' }}>
                Try adjusting your filters, location, or property type to discover more exclusive
                listings.
              </p>
              <button
